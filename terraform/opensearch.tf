...
resource "opensearch_index" "default" {
  ...
  mappings = jsonencode(
    {
      "properties" : {
        "${local.aoss_vector_field_name}" : { # tflint-ignore: terraform_deprecated_interpolation
          "type" : "knn_vector",
        ...
        "${local.aoss_metadata_field_name}" : { # tflint-ignore: terraform_deprecated_interpolation
          "type" : "text",
          "index" : "false"
        },
        "${local.aoss_text_field_name}" : { # tflint-ignore: terraform_deprecated_interpolation
          "type" : "text",
          "index" : "true"
        }
      }
